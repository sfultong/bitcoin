...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc<2 || mapArgs.count("-?") || mapArgs.count("-help"))
    {
        ...
        std::string strUsage = _("Bitcoin Unified ubitcoin-tx utility version") + " " + FormatFullVersion() + "\n\n" +
            _("Usage:") + "\n" +
              "  ubitcoin-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded bitcoinunified transaction") + "\n" +
              "  ubitcoin-tx [options] -create [commands]   " + _("Create hex-encoded bitcoinunified transaction") + "\n" +
              "\n";
