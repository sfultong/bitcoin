...
<context>
    ...
    <message>
        ...
        <translation>请求支付（生成二维码和 bitcoinunified: URI）</translation>
    </message>
    <message>
...
<context>
    ...
    <message>
        ...
        <translation>bitcoinunified:URI 附带的备注信息，将会和交易一起存储，备查。 注意：该消息不会通过莱特币网络传输。</translation>
    </message>
    <message>
...
for example: alertnotify=echo %%s | mail -s "BitcoinUnified Alert" admin@foo.com
        ...
        <translation>要使用 ubitcoind 或者 ubitcoin-qt 中的 -server 选项，您必须在配置文件中设置一个密码：
%s
建议您使用下列随机密码：
rpcuser=bitcoinunifiedrpc
rpcpassword=%s
...
例如 alertnotify=echo %%s | mail -s "BitcoinUnified Alert" admin@foo.com
</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation>初始化完整性检查失败。Bitcoin Unified 即将关闭。</translation>
    </message>
    <message>
