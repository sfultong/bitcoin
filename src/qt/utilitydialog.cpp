    ...
    ui(new Ui::HelpMessageDialog)
{
    ...
    QString version = tr("Bitcoin Unified") + " " + tr("version") + " " + QString::fromStdString(FormatFullVersion());
    ...
    if (about)
    {
        setWindowTitle(tr("About Bitcoin Unified"));
    ...
    QWidget(parent, f)
{
    ...
    layout->addWidget(new QLabel(
        tr("Bitcoin Unified is shutting down...") + "<br /><br />" +
