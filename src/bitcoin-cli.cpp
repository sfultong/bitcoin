...
std::string HelpMessageCli()
{
    ...
    strUsage += "\n" + _("SSL options: (see the BitcoinUnified Wiki for SSL setup instructions)") + "\n";
...
static bool AppInitRPC(int argc, char* argv[])
{
    ...
    if (argc<2 || mapArgs.count("-?") || mapArgs.count("-help") || mapArgs.count("-version")) {
        ...
        if (!mapArgs.count("-version")) {
            strUsage += "\n" + _("Usage:") + "\n" +
                  "  ubitcoin-cli [options] <command> [params]  " + _("Send command to Bitcoin Unified") + "\n" +
                  "  ubitcoin-cli [options] help                " + _("List commands") + "\n" +
                  "  ubitcoin-cli [options] help <command>      " + _("Get help for a command") + "\n";
